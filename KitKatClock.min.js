...
var f=f-26,d=p.fontSize||40;"number"!==typeof d&&(d=d.indexOf("pt")?4/3*parseFloat(d):parseFloat(d));var z=p.fontFamily||"Verdana, sans-serif",a=p.colors||{};a.text=a.text||"#FFFFFF";a.g=a.clock||"#050505";a.d=a.numerals||a.text;a.c=a.hand||"#960000";a.background=a.background||"#222222";a.b=a.meridian_background_on||a.hand;a.a=a.meridian_background_off||null;a.k=a.meridian_text||a.text;a.f=a.top_indicator_selected||a.hand;a.e=a.top_indicator_deselected||a.text;a.h=a.top_indicator_background||a.clock;
a.border=a.border||"#CCCCCC";for(var L in a)a[L]=M(a[L]);a.a||(a.a=N(a.b,a.background));var g=f/2,h=Math.PI,G=!1,t=!0,H=!0,D,B,y,q,n,C,m,v,s,w,k=e("<div>").hide(),u=e(this).on("mouseup",function(){if(e(this).is(":focus")){e(this).trigger("blur");var b=u.val().split(":"),a=parseInt(b[0]),b=parseInt(b[1]);k.attr({i:12==a?0:a,l:b});q.html((10>a?"&nbsp;":"")+a);n.html((10>b?"0":"")+b);t=!0;F();k.show();for(var c=u.offset(),a=e(window).width(),b=e(window).height(),d=e(document).width(),f=e(document).height(),
g=k.outerWidth(),E=k.outerHeight(),r=c.top,c=c.left,h=e("body").scrollTop(),m=e("body").scrollLeft(),s=h+b,p=m+a;r+E>f&&0<r;)r-=1;for(;c+g>d&&0<c;)c-=1;if(g<=a){for(;c<m;)c++;for(;c+g>p;)c--}else c=m-(g-a)/2;if(E<=b){for(;r<h;)r++;for(;r+E>s;)r--}else r=h-(E-b)/2;k.css({position:"absolute",top:r,left:c});a=q.html();q.html("12");b=n.height()+n.position().top-w.height()-5;d=n.width()+n.position().left;w.css({position:"absolute",top:b,left:d});q.html(a);e("body").on("click",function(a){a=a.target;e(a).is(k)||
0!=k.has(a).length||e(a).is(u)||J()});e("*",k).css("textShadow","none")}});(function(){e("body").append(k);""==u.val()&&u.val("12:00 AM");D=e("<canvas>");B=e("<canvas>");y=e("<canvas>");s=e("<input type='checkbox'>").on("change",function(){this.checked?(x(m[0],a.b),x(v[0],a.a),w.html("AM")):(x(v[0],a.b),x(m[0],a.a),w.html("PM"))}).hide();m=e("<canvas>");v=e("<canvas>");var b=e("<div>AM</div>").css({position:"absolute",top:10+f,left:10,width:d,height:d,textAlign:"center",lineHeight:d+"px",fontSize:d/
2,fontFamily:z,cursor:"pointer"}).on("click",function(){m.trigger("click")}),l=e("<div>PM</div>").css({position:"absolute",top:10+f,right:10,width:d,height:d,textAlign:"center",lineHeight:d+"px",fontSize:d/2,fontFamily:z,cursor:"pointer"}).on("click",function(){v.trigger("click")});w=e("<div>").css({color:a.e,display:"inline-block"});e([m,v]).each(function(){this.attr({height:d,width:d}).on("click",function(){s[0].checked=e(this).is(m);s.trigger("change")}).css({position:"absolute",top:f+10});this==
m?this.css("left",10):this.css("right",10);x(this[0],a.b)});-1!=u.val().toUpperCase().indexOf("AM")&&(s[0].checked=!0);s.trigger("change");k.css({width:f,height:f+2*d+10,zIndex:9999999,backgroundColor:a.background,borderRadius:"3px",padding:"3px 10px",border:"3px solid "+a.border,fontFamily:z,color:a.text});C=e("<div>").css({position:"absolute",top:d+10,left:10,width:f,height:f,cursor:"hand"});e([D,B,y]).each(function(){this.attr({width:f,height:f}).css({position:"absolute",top:"3px",left:"0px"})});
q=e("<span>").html(12).on("click",function(){t=!0;F()}).css({fontSize:d,cursor:"pointer"});n=e("<span>").html("00").on("click",function(){t=!1;K()}).css({fontSize:d,cursor:"pointer"});var c=e("<div>");c.append(q).append(e("<span>:</span>").css("fontSize",d)).append(n).append(s).css({position:"absolute",top:0,left:0,width:"100%",textAlign:"center",background:a.h,color:a.e});var p=e("<div>Done</div>").css({width:"100%",cursor:"pointer",textAlign:"center",fontSize:2/3*d,position:"absolute",borderTop:"1px solid "+
a.border,color:a.text,top:f+20+d,left:0}).on("click",J);C.append(D).append(B).append(y);k.append(C).append(c).append(p).append(m).append(v).append(b).append(l).append(w);b=D[0].getContext("2d");b.arc(g,g,g,0,2*h);b.fillStyle=a.g;b.fill();F();O();C.on("mousemove mousedown mouseup touchstart touchend touchcancel click touchmove",function(a){if(!(!H||a.offsetX>f||a.offsetY>f)){var b;if("touchmove"==a.type||"touchstart"==a.type)a.offsetX=a.originalEvent.touches[0].clientX,a.offsetY=a.originalEvent.touches[0].clientY,
b=C.offset(),a.offsetX-=b.left,a.offsetY-=b.top;switch(a.type){case "touchmove":b="mousemove";a.preventDefault();break;case "touchend":b="mouseup";break;case "touchcancel":b="mouseup";break;case "touchstart":b="mousedown";break;default:b=a.type}"mousedown"==b&&(G=!0);"mouseup"==b&&(G=!1);if("click"==b||"mousedown"==b||"mousemove"==b&&G){a=P(a.offsetX,a.offsetY,t?12:60);if(null==a)return;var c=h/2,c=c+a*h/(t?6:30),c=c>2*h?c-2*h:c;A(c);if(t){k.attr("hour",a);var c=k.attr("minute")||0,c=parseInt(c),
d=a}else k.attr("minute",a),d=k.attr("hour")||0,d=parseInt(d),c=a;c=Math.round(c);c=60==c?0:c;q.html((10>d&&0!=d?"&nbsp;":"")+(0==d?12:d));n.html((10>c?"0":"")+c)}"mouseup"==b&&t&&(t=!1,K(),H=!1,setTimeout(function(){H=!0},100))}})})()})}})(jQuery);