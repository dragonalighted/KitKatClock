...
30*h+"deg)"})},b/2)}a(function(){var d=a("<div class='kitkat-clock-element kitkat-container'>\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-time'>\t\t\t\t\t\t\t<span class='kitkat-clock-element kitkat-hour'>12</span>\t\t\t\t\t\t\t:\t\t\t\t\t\t\t<span class='kitkat-clock-element kitkat-minute'>00</span>\t\t\t\t\t\t\t<span class='kitkat-clock-element kitkat-am-pm'>AM</span>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock'>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-body'>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-hand'>\t\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-hand-line'></div>\t\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-hand-end'></div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-hours'>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-minutes'>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-cover'>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-am kitkat-clock-am-pm-active'><span class='kitkat-clock-element'>AM</span></div>\t\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-clock-pm'><span class='kitkat-clock-element'>PM</span></div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class='kitkat-clock-element kitkat-done'>\t\t\t\t\t\t\tDone\t\t\t\t\t\t</div>\t\t\t\t\t</div>");
