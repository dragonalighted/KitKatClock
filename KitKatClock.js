            ...
            function init_clock(){
                ...
                am_pm=$("<input type='checkbox'>").on("change", function(){
                    if (this.checked){
                        ...
                        am.css("background", colors.meridian_background_on);
                        pm.css("background", colors.meridian_background_off);
                        am_pm_text.html("AM");
                    }
                    else{
                        pm.css("background", colors.meridian_background_on);
                        am.css("background", colors.meridian_background_off);
                        am_pm_text.html("PM");
                    }
                }).hide();
                am=$("<canvas>");
                ...
                $([am, pm]).each(function(){
                    this.attr({
                        ...
                        background:colors.meridian_background_on,
                        position:"absolute",
                        top:clock_dim+10
                    });
                    if (this==am)
